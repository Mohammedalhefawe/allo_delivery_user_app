...
class ShopRepository implements ShopRepositoryInterface {
  ...
  @override
  Future<ApiResponse> getSellerList(String type, String? category,
      String? idCategory, int offset, String? query) async {
    try {
      final response = await dioClient!.get(
          "${AppConstants.sellerList}$type?${category != null ? "category_type=$category" : idCategory != null ? "category_id=$idCategory" : ""}${query != null ? "&query=$query" : ""}&limit=50&offset=$offset");
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
  ...
  @override
  Future<ApiResponse> getClearanceShopProductList(

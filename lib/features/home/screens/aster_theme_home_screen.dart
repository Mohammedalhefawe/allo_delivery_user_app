...
import 'package:flutter_sixvalley_ecommerce/features/banner/widgets/banner_categories_widget.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/home/widgets/aster_theme/discount_card_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/home/widgets/aster_theme/restaurants_categories_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/home/widgets/aster_theme/stores_categories_widget.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/product/screens/view_best_selling_products_screen.dart';
...
class AsterThemeHomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload) async {
    ...
    await shopController.getAllSellerList(
      reload,
      1,
      type: "all",
    );
    ...
    categoryController.getRestaurantCategoryList(true);
    categoryController.getStoreCategoryList(true);
                  ...
                  title: Row(
                    children: [
                      ...
                      Container(
                          ...
                          child: Image.asset(Images.logoImage, height: 35)),
                    ],
                  )),
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    const RestaurantCategoryListWidget(),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    //restaurants categories
                    const StoreCategoryListWidget(),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    //discounted product
                    const DiscountCardsWidget(
                      productType: 'store',
                    ),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    const DiscountCardsWidget(
                    ...
                    // Best Selling Restaurant Products
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        TitleRowWidget(
                          title:
                              getTranslated('best_selling_restaurant', context),
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => BestSellingProductsScreen(
                                productType: 'restaurant',
                                title: getTranslated(
                                        'best_selling_restaurant', context) ??
                        ...
                        Padding(
                          ...
                          child: BestSellingProductListWidget(
                            isHomePage: true,
                            productType: ProductType.bestSelling,
                            productTypeString: 'restaurant',
                    ...
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    // Best Selling Store Products
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        TitleRowWidget(
                          title: getTranslated('best_selling_store', context),
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => BestSellingProductsScreen(
                    ...
                    //           context,
                    //           MaterialPageRoute(
                    //               builder: (_) => TopProductListScreen(
                    //                     scrollController: _scrollController,
                    //                   ))),
                    //     ),
                    //     const SizedBox(height: Dimensions.paddingSizeSmall),

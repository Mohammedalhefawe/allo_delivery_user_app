...
class AppConstants {
  static const String appName = 'Allo Delivery';
  static const String slogan = 'E-Commerce Marketplace';
  static const String appVersion = '15.1';

  ///Flutter SDK 3.27.4

  static const String baseUrl = 'https://atoz.storylink.sy';
  ...
  static const String categoryUri = '/api/v1/categories/get';
  ...
  static const String bestSellingProductNewUri =
      '/api/v1/products/best-sellings';
  static const String discountedProductNewUri =
      '/api/v1/products/discounted-product';
